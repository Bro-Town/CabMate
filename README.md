<p align="center">
  <img src="assets/cabmate-logo.png" alt="CabMate" width="340">
</p>
...
- A big, clear speedometer. Pick ETCS, a classic BR gauge, a modern white dial or plain digital numbers.
- Upcoming speed limits, signals and stations on a strip along the bottom.
- Your power and brake handles, including trains with a separate brake like the Class 101.
- Colour themes, including a red night mode, plus a pile of settings to show exactly what you want and hide the rest.
- It works in English, Deutsch, Français, Polski, Nederlands, Español and हिन्दी.
...
CabMate works with the PC versions on Steam and Epic Games. Xbox and PlayStation aren't supported.
...
Come say hi on [Discord](https://discord.gg/sM6STGBA5j).
